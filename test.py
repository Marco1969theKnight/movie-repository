...
print(data)
data = m.read_a_directores(2)
print(data)
data = m.read_directores_nombre('Ryan')
print(data)
data = m.read_directores_nombre('Charles')
print(data)
data = m.read_directores_apellido('Coogler')
print(data)
data = m.read_directores_apellido('Chaplin')
print(data)
data = m.read_directores_alma_mater(4)
print(data)
data = m.read_directores_alma_mater(None)
print(data)
data = m.read_directores_anio_act_in(2009)
print(data)
data = m.read_directores_anio_act_in(1901)
print(data)
data = m.read_directores_anio_act_fin(2020)
print(data)
data = m.read_directores_anio_act_fin(1976)
print(data)
data = m.read_directores_anio_act_range(2008,2021)
print(data)
data = m.read_directores_anio_act_range(1900, 1980)
print(data)
...
print(data)
data = m.read_a_carrera_escritores(1,1)
print(data)
data = m.read_carrera_escritores_escritor(1)
print(data)
...
print(data)
data = m.read_a_carrera_actores(1,1)
print(data)
data = m.read_carrera_actores_actor(1)
print(data)
